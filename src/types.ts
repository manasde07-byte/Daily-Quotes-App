...
export const INITIAL_QUOTES: Quote[] = [
  { id: '1', category: 'Love', text: 'ভালোবাসা মানে একে অপরের পরিপূরক হওয়া। ❤️' },
  ...
  { id: 'li2', category: 'Life', text: 'জীবন মানেই সংগ্রাম, আর সংগ্রাম মানেই এগিয়ে চলা। 🚶‍♂️' },
  ...
  { id: '5', category: 'Sad', text: 'কিছু স্মৃতি খুব কষ্টের হয়, যা চাইলেও ভোলা যায় না। 💔🌧️' },
